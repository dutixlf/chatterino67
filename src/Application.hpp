...
public:
    ...
    virtual chatroom::ChatroomManager *getChatroomManager() = 0;
};
...
private:
    ...
    std::unique_ptr<chatroom::ChatroomManager> chatroomManager;
#ifdef CHATTERINO_HAVE_PLUGINS
...
public:
    ...
    chatroom::ChatroomManager *getChatroomManager() override;
