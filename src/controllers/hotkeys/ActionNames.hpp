    ...
    {HotkeyCategory::Split,
     {
         ...
         {"modDeleteHoveredMessage",
          ActionDefinition{"Delete the hovered message"}},
         {"modTimeoutHoveredUser",
          ActionDefinition{
              .displayName = "Timeout the hovered message's user",
              .argumentDescription = "[duration in seconds, default: 600]",
              .minCountArguments = 0,
              .maxCountArguments = 1,
          }},
         {"modBanHoveredUser",
          ActionDefinition{"Ban the hovered message's user"}},
         {"modUnbanHoveredUser",
          ActionDefinition{"Unban the hovered message's user"}},
